...
dates['tmp'] = 1
tweets_separate['tmp'] = 1

tweets_df = pd.merge(dates, tweets_separate, on=['tmp'])
tweets_df = tweets_df.drop('tmp', axis=1)

tweets_df.to_csv("blue_apron_tweets.csv", index = False)
